...
extern char **objs;
extern char **cons;
extern char **objscomp;
extern char **conscomp;
extern int ncon;
extern int popsizeA, popsizeB;
extern int ngenA, ngenB;
extern int ngen;
extern int nconA, nconB;
extern int nrealA, nrealB;
...
void create_symind_instance(individual *ind);
void read_results_ind(individual *ind);

void read_pop (population *pop, int gen);
